...
/*   Updated: 2024/06/05 15:23:48 by omfelk           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	ft_pipex(char *cmd, t_data *lst_data)
{
	...
	if (!ft_strncmp(path_ok, "/usr/bin/echo", ft_strlen("/usr/bin/echo")
		|| !ft_strncmp(path_ok, "/usr/bin/pwd", ft_strlen("/usr/bin/echo"))))
